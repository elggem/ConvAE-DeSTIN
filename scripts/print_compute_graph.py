...
theano.printing.pydotprint(train_0, outfile="./pics/symbolic_graph_opt_train_sup.png", var_with_name_simple=True) 
theano.printing.pydotprint(train_1, outfile="./pics/symbolic_graph_opt_test_sup.png", var_with_name_simple=True) 
